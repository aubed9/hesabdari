...
CREATE TABLE IF NOT EXISTS users (
    ...
    commission_rate REAL DEFAULT 0, -- Default general commission % (e.g. 1.5)
    is_active BOOLEAN DEFAULT 1,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS brands (
    ...
    website TEXT,
    description TEXT,
    commission_rate REAL DEFAULT 0, -- Brand specific commission override %
    is_active BOOLEAN DEFAULT 1
);
...
CREATE TABLE IF NOT EXISTS products (
    ...
    skin_type TEXT, -- Dry, Oily, Sensitive, Combination, Normal, All
    hair_type TEXT,
    usage_type TEXT, -- Daily, Professional, Night, SunCare
    is_active BOOLEAN DEFAULT 1,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS product_variants (
    ...
    shade TEXT, -- e.g. "120 Artist", "01 Porcelain", "Ruby Woo"
    color_hex TEXT, -- Visual shade representation e.g. "#C24248"
    size TEXT,
    volume TEXT, -- e.g. "30 ml", "5 g"
    weight TEXT,
    sku TEXT UNIQUE NOT NULL,
    barcode TEXT UNIQUE NOT NULL,
    purchase_price REAL NOT NULL, -- Standard/default purchase cost
    selling_price REAL NOT NULL, -- Retail price
    minimum_price REAL, -- Lowest allowable discount price
    tax_rate REAL DEFAULT 0, -- 0 or 10%
...
CREATE TABLE IF NOT EXISTS stock_transactions (
    ...
    reference_type TEXT, -- e.g. "ORDER", "PURCHASE_INVOICE", "TESTER_CONVERT"
...
CREATE TABLE IF NOT EXISTS suppliers (
    ...
    email TEXT,
    address TEXT,
    payment_terms TEXT, -- e.g. "30_DAYS", "CASH", "CHEQUE_45_DAYS"
    lead_time_days INTEGER DEFAULT 5,
    credit_limit REAL DEFAULT 0,
    authenticity_rating REAL DEFAULT 5.0, -- 1-5 scale
...
CREATE TABLE IF NOT EXISTS customers (
    ...
    rfm_segment TEXT DEFAULT 'NEW', -- Champions, Loyal, Potential Loyal, New, At Risk, Lost, VIP
    rfm_r_score INTEGER DEFAULT 5, -- 1-5
    rfm_f_score INTEGER DEFAULT 1, -- 1-5
    rfm_m_score INTEGER DEFAULT 1, -- 1-5
    clv REAL DEFAULT 0, -- Customer Lifetime Value
    notes TEXT,
    is_active BOOLEAN DEFAULT 1,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    total_cost REAL NOT NULL DEFAULT 0, -- Real COGS
...
CREATE TABLE IF NOT EXISTS exchanges (
    ...
    difference_amount REAL NOT NULL, -- positive if customer pays, negative if customer is refunded
...
CREATE TABLE IF NOT EXISTS journal_entries (
    ...
    reference_type TEXT, -- e.g. "POS_SALE", "PURCHASE", "SUPPLIER_PAYMENT", "TESTER_EXPENSE", "PAYROLL"
    reference_id INTEGER,
...
CREATE TABLE IF NOT EXISTS shipments (
    ...
    customer_id INTEGER REFERENCES customers(id),
    courier_name TEXT NOT NULL, -- e.g. "Alopeyk", "Miare", "Tipax", "Post"
